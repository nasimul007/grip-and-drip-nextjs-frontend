...
const WishlistButton = ({ item, className = "" }: WishlistButtonProps) => {
  ...
  const buttonClass = `flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 bg-brand-card border border-brand-border hover:text-brand-accent hover:border-brand-accent ${
    isInWishlist ? "text-brand-accent border-brand-accent" : "text-white"
  }`;
