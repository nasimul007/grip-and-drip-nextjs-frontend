...
const ShopWithSidebar = () => {
  ...
  return (
    <>
      <section className="relative overflow-x-hidden pb-20 pt-40 sm:pt-30 lg:pt-28 xl:pt-41.5 bg-brand-dark">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            >
              ...
              >
                <svg className="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M8 6.6L12.9 1.7C13.2 1.4 13.7 1.4 14 1.7L14.3 2C14.6 2.3 14.6 2.8 14.3 3.1L9.4 8L14.3 12.9C14.6 13.2 14.6 13.7 14.3 14L14 14.3C13.7 14.6 13.2 14.6 12.9 14.3L8 9.4L3.1 14.3C2.8 14.6 2.3 14.6 2 14.3L1.7 14C1.4 13.7 1.4 13.2 1.7 12.9L6.6 8L1.7 3.1C1.4 2.8 1.4 2.3 1.7 2L2 1.7C2.3 1.4 2.8 1.4 3.1 1.7L8 6.6Z" fill=""/>
                </svg>
              </button>
            ...
            <div className="xl:max-w-[870px] w-full">
              <div className="rounded-lg bg-brand-card border border-brand-border pl-3 pr-2.5 py-2.5 mb-2 mt-10 sm:mt-0">
                <div className="flex items-center justify-between">
                  {/* <!-- top bar left --> */}
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className="xl:hidden flex items-center justify-center w-10.5 h-9 rounded-[5px] border border-brand-border bg-brand-card text-white hover:bg-brand-hover hover:border-brand-accent"
                    >
                      <svg
              ...
              {loading ? (
                ...
                <div
                  className={`${
                    productStyle === "grid"
                      ? "grid grid-cols-2 lg:grid-cols-4 gap-x-2.5 gap-y-2.5"
