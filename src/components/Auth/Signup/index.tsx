        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="max-w-[570px] w-full mx-auto rounded-[10px] bg-brand-card border border-brand-border p-4 sm:p-7.5 xl:p-8">
            ...
            <div className="flex flex-col gap-4">
              <button
                type="button"
                className="flex justify-center items-center gap-3.5 rounded-lg border border-brand-border bg-brand-surface p-3 ease-out duration-200 hover:bg-brand-card"
              >
                <svg
                  width="20"
                  height="20"
            ...
            <span className="relative z-1 block font-medium text-center mt-4">
              <span className="block absolute -z-1 left-0 top-1/2 h-px w-full bg-brand-border"></span>
              <span className="inline-block px-3 bg-brand-card">Or</span>
            </span>
            ...
            <div className="mt-4">
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex justify-center font-medium text-white bg-brand-accent py-3 px-6 rounded-lg ease-out duration-200 hover:bg-brand-hover mt-6 disabled:opacity-50"
                >
                ...
                <p className="text-center mt-5">
                  ...
                  <Link
                    href="/signin"
                    className="text-brand-accent ease-out duration-200 hover:text-brand-hover pl-2"
                  >
                    Sign in Now
                  </Link>
                </p>
